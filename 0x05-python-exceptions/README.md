...
This a way of handling errors, catching them and running other code incase we encounter and error in Python. These are similar to try, catch and finally in other programming languanges. Python also allows as raise our own exceptions or errors just like we can throw errors.
